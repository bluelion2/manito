        ...
        {`
          ...
          .snow::after {
            ...
            background-image: radial-gradient(5px 5px at 386px 424px, white 50%, rgba(0, 0, 0, 0)),
              ...
              radial-gradient(
                4px 4px at 418px 475px,
                rgba(255, 255, 255, 0.7) 50%,
                rgba(0, 0, 0, 0)
              ),
              radial-gradient(3px 3px at 13px 101px, rgba(255, 255, 255, 0.6) 50%, rgba(0, 0, 0, 0)),
              radial-gradient(
                4px 4px at 491px 376px,
                rgba(255, 255, 255, 0.8) 50%,
                rgba(0, 0, 0, 0)
              ),
              radial-gradient(6px 6px at 64px 353px, white 50%, rgba(0, 0, 0, 0)),
              radial-gradient(6px 6px at 221px 288px, white 50%, rgba(0, 0, 0, 0)),
              radial-gradient(
                5px 5px at 200px 472px,
                rgba(255, 255, 255, 0.8) 50%,
                rgba(0, 0, 0, 0)
              ),
              radial-gradient(
